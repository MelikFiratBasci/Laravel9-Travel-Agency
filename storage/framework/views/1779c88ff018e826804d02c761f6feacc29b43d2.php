    ...
    <div class="col-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="<?php echo e(route('admin_image_store',['package_id'=>$data->id])); ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="badge badge-danger"><a class="nav-link"
                                                                         href="<?php echo e(route('admin_image_delete',['id'=>$rs->id,'package_id'=>$rs->package_id])); ?>"
...
<?php /**PATH C:\php\laravel\Laravel9-Travel-Agency\resources\views/admin/_image_add.blade.php ENDPATH**/ ?>