...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?php echo e(asset('assets')); ?>/admin/images/logo.png" />
</head>
            ...
            <div class="row w-100 mx-0">
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.logincheck')); ?>" method="post" class="pt-3">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="my-2 d-flex justify-content-between align-items-center">
                                <div class="form-check">
                                    <label class="form-check-label text-muted">
                                        <input type="checkbox" class="form-check-input" name="login" value="login">
                                        Keep me signed in
                                    </label>
                                </div>
...
<?php /**PATH C:\php\laravel\Laravel9-Travel-Agency\resources\views/admin/login.blade.php ENDPATH**/ ?>