<div class="tab-pane fade" id="package-tab" role="tabpanel" aria-labelledby="package-nav">
    <div class="table-responsive">
            ...
            <label style="width: 200px"
                ...
                <a href="<?php echo e(route('user_package_add')); ?>"
        ...
        <table class="table table-bordered">
            ...
            <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('user_image_add',['package_id'=>$rs->id])); ?>"
                    ...
                    <td>
                        <label class="badge badge-warning badge-outline-danger">
                            <a href="<?php echo e(route('user_package_edit',['id'=>$rs->id])); ?>"
                               class="nav-link">edit</a></label>
                    </td>
                    <td>
                        <label class="badge badge-danger"><a class="nav-link"
                                                             href="<?php echo e(route('user_package_delete',['id'=>$rs->id])); ?>"
...
<?php /**PATH C:\php\laravel\Laravel9-Travel-Agency\resources\views/home/user_package.blade.php ENDPATH**/ ?>