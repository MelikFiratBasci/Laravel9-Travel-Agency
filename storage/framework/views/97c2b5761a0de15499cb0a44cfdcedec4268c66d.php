                                ...
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $datalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p><?php echo e($rs->name); ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo e($rs->email); ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo e($rs->phone); ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo e($rs->subject); ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo e($rs->message); ?></p>
                                            </td>
                                            ...
                                            <td>
                                                <label class="badge badge-warning badge-outline-danger">
                                                    <a href="<?php echo e(route('admin_message_edit',['id'=>$rs->id])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\php\laravel\Laravel9-Travel-Agency\resources\views/admin/_message.blade.php ENDPATH**/ ?>